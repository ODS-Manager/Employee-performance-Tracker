// ============ Base Types ============
export type UserRole = 'superadmin' | 'admin' | 'team_lead' | 'examiner'
...
// ============ Metrics Types ============
export interface ExaminerMetrics {
  id: number
  userId: number
  teamId: number | null
  orgId: number
...
export interface ExaminerMetricsListResponse {
  items: ExaminerMetrics[]
  total: number
}
...
export interface TeamMetrics {
  ...
  avgOrderCompletionMinutes: number | null
  activeExaminersCount: number
  teamEfficiencyScore: number | null
  ordersPerExaminer: number | null
...
export interface TeamProductivity {
  ...
  examiners: ExaminerProductivity[]
}

export interface ProductivityLeaderboardResponse {
  items: ExaminerProductivity[]
  total: number
}
...
// ============ Examiner Weekly Target Types ============
export interface ExaminerWeeklyTarget {
  id: number
  userId: number
  teamId: number
...
export interface ExaminerTargetHistoryResponse {
  userId: number
  teamId: number
  targets: ExaminerWeeklyTarget[]
}
...
export interface TeamMonthlyAttendanceReport {
  teamId: number
  teamName: string
  startDate: string
  endDate: string
  examiners: ExaminerMonthlyAttendance[]
}
